...
public class PoltronaService extends AsyncTask<String,Void,String> {
    @Override
    protected String doInBackground(String... strings) {
        URL url = null;
        try {

            url = new URL("https://service.davesmartins.com.br/api/voo/"+strings[0]+"/poltronas");
            ...
            urlConnection.setRequestProperty("code", strings[1]);
